...
# ====================
from pyDOE3 import *
from doepy3.pydoe_corrected import (
    fullfact_corrected,
    fracfact_corrected,
    fracfact_by_res,
    bbdesign_corrected,
...
# ===========================================================================================================
# Function for constructing a DataFrame from a numpy array generated by pyDOE3 function and individual lists
# ===========================================================================================================
...
def construct_df(x, r):
    ...
    Function for constructing a DataFrame from a numpy array generated by pyDOE3 function and individual lists
    """
    df = pd.DataFrame(data=x, dtype="float64")
    for i in df.index:
...
def build_lhs(factor_level_ranges, num_samples=None, prob_distribution=None, random_state=None):
    """
